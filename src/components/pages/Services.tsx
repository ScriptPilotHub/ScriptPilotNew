  ...
  <div className="min-h-screen bg-white">
    ...
    <section className="pt-32 pb-20 px-4 bg-slate-50">
      <div className="max-w-6xl mx-auto text-center">
        <div className="w-20 h-20 bg-slate-800 rounded-2xl flex items-center justify-center mx-auto mb-8 shadow-lg">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
          <a 
            href="#contact" 
            className="bg-slate-800 text-white px-8 py-4 rounded-xl font-semibold hover:bg-slate-700 transition-all duration-300 flex items-center gap-2 shadow-lg hover:shadow-xl hover:-translate-y-1 transform"
          >
            Get Started Today
          ...
          <a
            ...
            className="border-2 border-slate-300 text-slate-700 px-8 py-4 rounded-xl font-semibold hover:border-slate-600 hover:bg-slate-600 hover:text-white transition-all duration-300"
          >
      ...
      <div className="max-w-6xl mx-auto px-4">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
          {[
            ...
            <div key={index} className="bg-slate-50 rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-500 transform hover:-translate-y-2">
    ...
    <section className="py-20 bg-slate-50">
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          {/* Project Initiation */}
          <div className="group bg-white rounded-2xl border-2 border-slate-200 shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:scale-105 hover:-translate-y-3">
            <div className="p-8 text-center">
              <div className="w-16 h-16 bg-slate-800 rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:scale-110 group-hover:rotate-12 transition-all duration-500 shadow-lg">
              ...
              <p className="text-slate-700 mb-6">Get started with your custom website project</p>
              ...
              <a
                href="#contact"
                className="w-full bg-slate-800 text-white px-6 py-3 rounded-xl font-semibold hover:bg-slate-700 transition-all duration-500 inline-block transform hover:-translate-y-1 shadow-lg hover:shadow-xl"
              >
                Start Project
              </a>
            </div>
          ...
          {/* Final Payment */}
          <div className="bg-white rounded-2xl border-2 border-blue-200 shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:scale-105 hover:-translate-y-3 group relative">
            <div className="absolute -top-4 left-1/2 transform -translate-x-1/2">
              <span className="bg-blue-500 text-white px-4 py-2 rounded-full text-sm font-bold">COMPLETION</span>
            </div>
            <div className="p-8 text-center">
              <div className="w-16 h-16 bg-blue-600 rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:scale-110 group-hover:rotate-12 transition-all duration-500 shadow-lg">
              ...
              <p className="text-slate-700 mb-6">Final payment when your website is complete and deployed</p>
              <ul className="text-left space-y-3 mb-8">
                <li className="flex items-center gap-3 text-sm text-slate-700">
                  <CheckCircle className="w-4 h-4 text-green-600 flex-shrink-0" />
              ...
              <div className="w-full bg-blue-600 text-white px-6 py-3 rounded-xl font-semibold text-center transform hover:-translate-y-1 transition-all duration-300 shadow-lg">
                Paid on Completion
              </div>
            </div>
          </div>
          ...
          {/* Maintenance */}
          <div className="bg-white rounded-2xl border-2 border-slate-200 shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:scale-105 hover:-translate-y-3 group">
            <div className="p-8 text-center">
              <div className="w-16 h-16 bg-slate-800 rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:scale-110 group-hover:rotate-12 transition-all duration-500 shadow-lg">
              ...
              <p className="text-slate-700 mb-2">Keep your website secure and up-to-date</p>
              <p className="text-sm text-slate-600 font-semibold mb-6">Optional Service</p>
              <ul className="text-left space-y-3 mb-8">
                <li className="flex items-center gap-3 text-sm text-slate-700">
                  <CheckCircle className="w-4 h-4 text-green-600 flex-shrink-0" />
              ...
              <div className="w-full border-2 border-slate-600 text-slate-600 px-6 py-3 rounded-xl font-semibold text-center hover:bg-slate-600 hover:text-white transition-all duration-500 transform hover:-translate-y-1 shadow-lg hover:shadow-xl">
                Optional Add-on
              </div>
            </div>
          </div>
      ...
      <div className="max-w-6xl mx-auto px-4 text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
          <a
            ...
            className="bg-white text-slate-900 px-8 py-4 rounded-xl font-semibold hover:bg-slate-100 transition-all duration-300 shadow-lg hover:shadow-xl hover:-translate-y-1 transform"
          >
            Get Quote
          </a>
          <a
            href="#contact"
            className="border-2 border-white text-white px-8 py-4 rounded-xl font-semibold hover:bg-white hover:text-slate-900 transition-all duration-300 transform hover:-translate-y-1"
          >
            Contact Us
          </a>
        </div>

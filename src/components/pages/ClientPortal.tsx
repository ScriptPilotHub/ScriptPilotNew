...
export const ClientPortal: React.FC = () => (
  <div className="min-h-screen bg-white">
    {/* Hero Section */}
    <section className="pt-32 pb-20 px-4 bg-green-50">
      <div className="max-w-6xl mx-auto text-center">
        ...
        <p className="text-lg sm:text-xl text-green-700 max-w-3xl mx-auto mb-8 px-4">
        ...
        <div className="grid sm:grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
          ...
          <div className="group bg-white rounded-2xl border-2 border-green-200 shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:scale-105 hover:-translate-y-3">
            <div className="p-6 sm:p-8 text-center">
              <div className="w-16 h-16 bg-green-600 rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:scale-110 group-hover:rotate-12 transition-all duration-500 shadow-lg">
          ...
          <div className="group bg-white rounded-2xl border-2 border-green-200 shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:scale-105 hover:-translate-y-3 relative">
            <div className="absolute -top-4 left-1/2 transform -translate-x-1/2">
              <span className="bg-green-500 text-white px-4 py-2 rounded-full text-sm font-bold">COMPLETION</span>
            </div>
            <div className="p-6 sm:p-8 text-center">
              <div className="w-16 h-16 bg-green-600 rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:scale-110 group-hover:rotate-12 transition-all duration-500 shadow-lg">
              ...
              <p className="text-sm text-green-600 font-semibold mb-2">(Only pay when project is complete)</p>
              <div className="mb-4">
          ...
          <div className="group bg-white rounded-2xl border-2 border-green-200 shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:scale-105 hover:-translate-y-3">
            <div className="p-6 sm:p-8 text-center">
              ...
              <p className="text-sm text-green-600 font-semibold mb-6">Optional Service</p>
              <ul className="text-left space-y-3 mb-8">
                <li className="flex items-center gap-3 text-sm text-green-700">
                  <CheckCircle className="w-4 h-4 text-green-600 flex-shrink-0" />
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-full border-2 border-green-600 text-green-600 px-6 py-3 rounded-xl font-semibold hover:bg-green-600 hover:text-white transition-all duration-500 inline-flex items-center justify-center gap-2 shadow-lg hover:shadow-xl hover:-translate-y-1 transform"
              >
                <CreditCard className="w-5 h-5" />
                Subscribe $150/mo
              </a>
    ...
    <section className="py-20 bg-white">
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="grid sm:grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
          <div className="bg-green-50 rounded-2xl p-6 sm:p-8 text-center shadow-lg hover:shadow-xl transition-all duration-500 transform hover:-translate-y-3">

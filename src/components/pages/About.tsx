        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
          {[
            ...
            <div key={index} className="group">
              <div className="text-4xl sm:text-5xl font-bold text-gray-900 mb-3 group-hover:text-gray-600 transition-colors">
                {stat.value}
              </div>
    ...
    <section className="py-32 bg-white">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="grid lg:grid-cols-2 gap-12 max-w-5xl mx-auto">
          <div className="bg-gray-50 rounded-3xl p-8 text-center shadow-lg hover:shadow-xl transition-all duration-500 transform hover:-translate-y-2">
            ...
            <p className="text-gray-600 font-semibold mb-6">Co-Founder & Lead Developer</p>
          ...
          <div className="bg-gray-50 rounded-3xl p-8 text-center shadow-lg hover:shadow-xl transition-all duration-500 transform hover:-translate-y-2">
            ...
            <p className="text-gray-600 font-semibold mb-6">Co-Founder & Business Strategy</p>
            <p className="text-gray-700 leading-relaxed">
      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="grid lg:grid-cols-3 gap-12">
          {[
            ...
            <div key={index} className="bg-white rounded-3xl p-8 shadow-lg hover:shadow-2xl transition-all duration-500 group transform hover:scale-105 hover:-translate-y-3">
              <div className="w-16 h-16 bg-gray-900 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 group-hover:rotate-12 transition-all duration-500 transform shadow-lg">
